    ...
    <div className="h-full flex overflow-hidden bg-[#F0F4F8]">
      ...
      <div className="w-[230px] bg-white flex flex-col flex-shrink-0 border-r border-[#E2E8F0]">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
          ...
          <button onClick={onLogout} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-left text-[#EF4444] hover:bg-[#FEF2F2] text-[12px] font-semibold transition-colors">
